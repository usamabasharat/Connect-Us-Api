-- CreateEnum
CREATE TYPE "role_types" AS ENUM ('admin', 'super_admin', 'manager', 'user');

-- CreateEnum
CREATE TYPE "designation_types" AS ENUM ('se', 'pm', 'apm', 'tl', 'atl', 'sse', 'ase');

-- CreateEnum
CREATE TYPE "user_types" AS ENUM ('host', 'participation');

-- CreateEnum
CREATE TYPE "activity_types" AS ENUM ('mock', 'codereview', 'annual', 'biannual', 'quarterly', 'one');

-- CreateEnum
CREATE TYPE "day_types" AS ENUM ('monday', 'tuesday', 'wednesday', 'thursday', 'friday');
...
CREATE TABLE "users" (
    ...
    "designation" "designation_types" NOT NULL,
